...
get_dictionary_and_links <-
        function(conn,
                ...
                for (i in 1:max_page) {
                        ...
                        page_scrape <- xml2::read_html(page_url)
                ...
                if (verbose) {
                        cli::rule(left = "Writing Changes to DATA_DICTIONARY")
                }
                        ...
                        if (verbose) {
                                cli::rule(left = "Writing Changes to DRUG_LINK")
                        }
